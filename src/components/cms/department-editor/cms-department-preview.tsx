import { LayoutTemplate, RotateCcw, Send } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <div className="relative flex h-187.5 w-full flex-col overflow-hidden rounded-4xl border border-slate-200 bg-white shadow-xl">
          {/* Header Area */}
          <div
